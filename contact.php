...
<div id="popupMessage" style="display: none; position: fixed; top: 20px; right: 20px; padding: 10px; background: green; color: white; border-radius: 5px;">
...
<script>
    document.getElementById('sendEmailButton').addEventListener('click', function() {
        ...
        var mailtoLink = 'mailto:henry.management@thekingmoss.com' +
